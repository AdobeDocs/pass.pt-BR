...
Para melhor precisão de dados, recomendamos os relatórios apresentados nesta página [exemplos de relatórios CMU](/help/concurrency-monitoring/reports/cm-usage-reports-examples.md)
