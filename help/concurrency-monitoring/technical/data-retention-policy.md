...
*Dados de sequência de cliques* representam dados compartilhados por clientes nas pulsações da sessão (por exemplo, subjectID, mvpdName e metadados). Todos os campos de metadados personalizados são mencionados nos [Atributos de metadados padrão](/help/concurrency-monitoring/technical/standard-metadata-attributes.md).
