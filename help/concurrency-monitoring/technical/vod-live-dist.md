...
* [Atributos de metadados padrão de monitoramento de simultaneidade](/help/concurrency-monitoring/technical/standard-metadata-attributes.md)
* [Visão geral da API de monitoramento de concorrência](/help/concurrency-monitoring/api/cm-api-overview.md)
