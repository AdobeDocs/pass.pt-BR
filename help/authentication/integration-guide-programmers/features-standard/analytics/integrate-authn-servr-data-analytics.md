...
| Tipo de SDK | O SDK cliente usado (Flash, HTML5, nativo do Android, iOS, sem clientes etc.) |
...
* A variável de visitante único está definida como a ID de usuário do MVPD
