...
### &#x200B;2. Recuperar perfil para mvpd específico obtido por meio de autenticação básica ou logon único usando o método Token de serviço
...
### &#x200B;3. Recuperar perfil para mvpd específico obtido por meio de autenticação básica ou logon único usando o método de identidade da plataforma
