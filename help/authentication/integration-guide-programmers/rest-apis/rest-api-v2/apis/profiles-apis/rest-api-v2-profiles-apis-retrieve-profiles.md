            ...
            <tr>
               ...
               <td>
                  ...
                  Os valores possíveis são:<ul>
                    <li><b>mvpd (por exemplo, Spectrum, Cablevision, etc.)</b><br/>O perfil foi criado como resultado de: autenticação básica, logon único usando identidade de plataforma ou logon único usando token de serviço.</li>
...
### &#x200B;1. Recuperar perfis obtidos por meio da autenticação básica
...
### &#x200B;2. Recuperar perfis obtidos por meio da autenticação básica ou do logon único usando o método Token de serviço
...
### &#x200B;3. Recuperar perfis obtidos por meio da autenticação básica ou do logon único usando o método de identidade da plataforma
