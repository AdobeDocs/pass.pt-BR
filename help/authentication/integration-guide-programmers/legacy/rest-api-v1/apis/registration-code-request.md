...
| informações:deviceId | Tipo de dispositivo Base64 |
| informações:deviceInfo | Informações de Dispositivo Normalizado Base64 criadas com base em informações recebidas do Agente do Usuário, Informações do Dispositivo X ou informações do dispositivo |
| informações:userAgent | Agente do usuário enviado pelo aplicativo |
| informações:originalUserAgent | Agente do usuário enviado pelo aplicativo |
| informações:authorizationType | OAUTH2 para chamadas usando DCR |
| informações:sourceApplicationInformation | Informações do aplicativo conforme configurado no DCR |
