...
<table>
   ...
   <tr>
      ...
      <td>A lista de recursos que exigem uma decisão do MVPD antes que possam ser reproduzidos.</td>
      <td><i>obrigatório</i></td>
   </tr>
   <tr>
      ...
      <td>
         ...
         <table>
            ...
            <tr>
                ...
                <td>O identificador de recurso para o qual a decisão de autorização é retornada.</td>
                <td><i>obrigatório</i></td>
            </tr>
            <tr>
                <td style="background-color: #DEEBFF;">serviceProvider</td>
            ...
            <tr>
               ...
               <td>
                  ...
                  <table>
                     ...
                     <tr>
                        <td style="background-color: #DEEBFF;">mvpd</td>
                        <td>A decisão é emitida pelo endpoint de autorização do MVPD.</td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                        ...
                        <td>A decisão é emitida como resultado do recurso de autorização fictícia.</td>
                     </tr>
                  </table>
               <td><i>obrigatório</i></td>
            </tr>
               ...
               <td>
                  ...
                  <table>
                     ...
                     <tr>
                        ...
                        <td>O carimbo de data/hora antes do qual o token de mídia não é válido.</td>
                     </tr>
                     <tr>
                        <td style="background-color: #DEEBFF;">notAfter</td>
                        <td>O carimbo de data/hora após o qual o token de mídia não é válido.</td>
                     </tr>
                     <tr>
                        <td style="background-color: #DEEBFF;">serializedToken</td>
                        <td>O token de mídia codificado na Base64.</td>
                     </tr>
                  </table>
               <td>opcional</td>
            </tr>
...
### 1. Recuperar decisões de autorização usando o mvpd normal
...
### 2. Recuperar decisões de autorização usando a passagem temporária
...
### 3. Recuperar decisões de autorização usando passe temporário promocional
...
### 4. Recuperar decisões de autorização usando mvpd degradado
