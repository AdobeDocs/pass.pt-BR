...
* **Protocolo OAuth:**
   * Para habilitar HBA, consulte [Guia do usuário do painel do Adobe Pass TVE](/help/authentication/tve-dashboard-user-guide.md)
