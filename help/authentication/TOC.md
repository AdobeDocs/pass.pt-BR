...
- Versões do produto {#product-releases}
  - 2026 {#2026}
    - {hide-from-toc}[Notas de versão da Autenticação do Adobe Pass 3.9.0](notes-releases/auth-rn-390.md)
    - [Notas de versão da Autenticação Adobe Pass 3.8.0](notes-releases/auth-rn-380.md)
    - [Notas de versão da Autenticação Adobe Pass 3.7.0](notes-releases/auth-rn-370.md)
    - [Notas de versão da Autenticação Adobe Pass 3.6.0](notes-releases/auth-rn-360.md)
  - 2025 {#2025}
    - [Notas de versão do Adobe Pass Authentication Android 3.8.0](notes-releases/authn-rn-android-380.md)
    - [Notas de versão da Autenticação Adobe Pass 3.5.0](notes-releases/auth-rn-350.md)
...
- Guia De Integração Para Programadores {#integration-guide-programmers}
  ...
  - REST APIs {#rest-apis}
    ...
    - REST API V2 {#rest-api-v2}
      ...
      - [Regras da IA REST API V2](integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-ai-rules.md)
  ...
  - Recursos Premium {#features-premium}
    ...
    - Análise {#analytics}
      ...
      - [Uso da Experience Cloud ID na autenticação da Adobe Pass](integration-guide-programmers/features-premium/analytics/exp-cloud-id-authn.md)
  - Herdados {#legacy}
...
- Guia Do Usuário Para O Painel TVE {#user-guide-tve-dashboard}
  ...
  - [Painel ESM](/help/authentication/user-guide-tve-dashboard/tve-dashboard-esm.md)
