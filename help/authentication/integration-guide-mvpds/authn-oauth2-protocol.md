...
![Diagrama para mostrar o Fluxo de autenticação na Autenticação do Adobe que se comunica com o MVPD no protocolo selecionado na configuração.](/help/authentication/assets/authn-flow.png)
