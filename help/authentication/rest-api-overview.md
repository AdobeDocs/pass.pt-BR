...
Para usar a API REST de autenticação do Adobe Pass, os dispositivos devem atender ou exceder os requisitos técnicos mínimos listados na seção API REST da [Documento Requisitos da plataforma de autenticação/dispositivo/ferramentas do Adobe Pass](#general_clientless_reqs).
